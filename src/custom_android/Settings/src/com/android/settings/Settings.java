...
import com.android.settings.DarkCloudModeEnabler;
...
public class Settings extends PreferenceActivity
	...
	private final DarkCloudModeEnabler mDCloudEnabler;
        ...
        static int getHeaderType(Header header) {
            ...
            } else if (header.id == R.id.dcloud_settings || header.id == R.id.wifi_settings || header.id == R.id.bluetooth_settings) {
	    ...
	    mDCloudEnabler = new DarkCloudModeEnabler(context, new Switch(context));
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (headerType) {
                ...
                case HEADER_TYPE_SWITCH:
                    ...
                    } else if (header.id == R.id.dcloud_settings) {
			// DCloud ON & OFF
			mDCloudEnabler.setSwitch(holder.switch_);
		    } else {
	    ...
	    mDCloudEnabler.resume();
        }

        public void pause() {
            mWifiEnabler.pause();
            mBluetoothEnabler.pause();
	    mDCloudEnabler.pause();
        }
    }
    ...
    public static class DarkCloudSettingActivity extends Settings { /* empty */ }
